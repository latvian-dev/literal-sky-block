...
public interface LSBItems {
	...
	Supplier<Item> END_SKY_BLOCK = REGISTER.register("end_sky_block", () -> new BlockItem(LSBBlocks.END_SKY_BLOCK.get(), new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
}
